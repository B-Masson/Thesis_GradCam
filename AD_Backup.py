...
print("\nIMPLEMENTATION: TWIN")
print("CURRENT TEST: Recovering what we've lost.")
...
limiter = False
pure_mode = False
modelname = "ADModel_TWIN_v1.5" #Next in line: ADMODEL_NEO_v1.3
logname = "TWIN_V1.5" #Neo_V1.3
if not testing_mode:
    if not pure_mode:
...
if testing_mode or pure_mode:
    epochs = 25 #Small for testing purposes
    batches = 1
else:
