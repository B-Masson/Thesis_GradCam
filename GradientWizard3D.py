# Hark, for there is another wizard! The Gradient Wizard has graced us with his might
...
for i in range(1):
    ...
    labbo = []
    labbo.append(labs[i])
    print("x shape:", image[0].shape)
    print("y:", labbo)
    print("Getting gradients")
    grads = keract2.get_gradients_of_activations(model, image, labbo, layer_names='conv3d')
