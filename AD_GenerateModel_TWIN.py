...
print("\nIMPLEMENTATION: TWIN")
print("CURRENT TEST: Assessing the model, but this time with STRIPPED files.")
...
strip_mode = False
norm_mode = True
modelname = "ADModel_TWIN_v1.5_strip" #Next in line: ADMODEL_NEO_v1.3
logname = "TWIN_V1.5_strip" #Neo_V1.3
if not testing_mode:
    if not pure_mode:
